...
export function CheckoutPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (
      ...
      toast.error("Please fill in card information");
      return;
    }
    setLoading(true);
    try {
        ...
        <div className="co-root">
          ...
          >
            ...
            >
              ...
              <p style={{ color: "#64748b", marginBottom: 6, fontSize: 14 }}>
          ...
          <form onSubmit={handleSubmit}>
            <div className="co-layout">
              ...
              >
                      ...
                      <div className="co-field">
                        ...
                        {isAuthenticated && addressOptions.length > 0 ? (
                          ...
                          <input
                            ...
                            value={formData.addressId}
                            onChange={(e) =>
                              handleChange("addressId", e.target.value)
                            }
                            placeholder="1"
                          />
                        )}
                  ...
                  >
                    {deliveryOptions.map((opt) => {
                      ...
                      return (
                        <div
                          key={opt.id}
                          className={`co-option ${active ? "co-option-active" : ""}`}
                ...
                <div className="co-card">
                  ...
                  >
                    ...
                    {formData.paymentMethod === "card" && (
                      <div
                        className="co-payment-expand"
                        style={{ animationName: "expandIn" }}
                      >
                        <div
                          style={{
                            height: 1,
                        ...
                        >
                            ...
                            >
                              ...
                              >
                                ...
                                {[44, 48, 52, 56, 60, 64, 68, 72, 76].map((x) =>
                                  [44, 48, 52, 56, 60, 64, 68, 72, 76].map(
                                    (y) =>
                                      Math.sin(x * y) > 0.2 ? (
                                        <rect
                                          key={`${x}-${y}`}
                          ...
                          <div style={{ flex: 1, minWidth: 160 }}>
                            ...
                            {[
                              ...
                              {
                                label: "Account Name",
                                value: "TECHSTORE CO. LTD",
                              },
                              {
                                label: "Amount",
                                value: `$${finalTotal.toLocaleString("en-US", { minimumFractionDigits: 2 })}`,
                              },
                              {
                                label: "Reference",
                            ...
                            >
                              ⚠️ Please include the reference code in your
                              transfer note
                            </div>
                          </div>
                        </div>
                        ...
                        >
                          ...
                          <div>
                            ...
                            <div style={{ fontSize: 12, color: "#16a34a" }}>
                              Have cash ready when the delivery arrives
                            </div>
                          </div>
                        </div>
                      </div>
              ...
              <div className="co-summary">
                <div
                  style={{
                    background: "linear-gradient(135deg,#0b1120,#0f2044)",
                ...
                >
                  ...
                  <div style={{ fontSize: 12, color: "rgba(148,163,184,.7)" }}>
                ...
                <div style={{ padding: "16px 24px" }}>
                  ...
                  >
                    {[
                      {
                        label: "Subtotal",
                        value: `$${totalPrice.toLocaleString("en-US", { minimumFractionDigits: 2 })}`,
                        green: false,
                      },
                      {
                        label: "Shipping",
                      ...
                      ...(deliveryFee > 0
                        ? [
                            {
                              label: `${formData.deliveryMethod === "express" ? "Express" : "Overnight"} fee`,
                      ...
                      {
                        label: "Tax (8%)",
                        value: `$${tax.toLocaleString("en-US", { minimumFractionDigits: 2 })}`,
                        green: false,
                      },
